        ...
        <div class="dashboard-grid">
            <div>
                ...
                <div style="margin-bottom:15px">
                    <input type="text" id="j-search" style="width:100%; padding:12px; border-radius:10px; border:1px solid #ddd" placeholder="🔎 Caută în note..." data-i18n-placeholder="jurnal_search" oninput="renderJurnal()">
                </div>
                <div class="card-box" style="border: 2px solid var(--accent-green)">
                    ...
                    <textarea id="j-text" rows="3" style="width:100%; padding:10px; border-radius:8px; border:1px solid #ddd; box-sizing:border-box; font-family: inherit;" placeholder="Notează observațiile..." data-i18n-placeholder="note_observations"></textarea>
                ...
                <div id="jurnal-filter-bar" style="display:flex;gap:6px;flex-wrap:wrap;margin-top:16px;margin-bottom:4px;">
    <button class="jf-btn active" onclick="setJurnalFilter('toate',this)">📋 Toate</button>
    <button class="jf-btn" onclick="setJurnalFilter('inspectie',this)">🔍 Inspecții</button>
    <button class="jf-btn" onclick="setJurnalFilter('tratament',this)">💊 Tratamente</button>
    <button class="jf-btn" onclick="setJurnalFilter('sarcina',this)">✅ Sarcini</button>
    <button class="jf-btn" onclick="setJurnalFilter('foto',this)">📸 Foto</button>
    <button class="jf-btn" onclick="setJurnalFilter('ok',this)">💚 Stup OK</button>
</div>
<div id="jurnal-list" style="margin-top:12px"></div>
            </div>
            <div>
                <h2>📝 Sarcini & Tratamente</h2>
                <div class="card-box">
                    <input type="text" id="t-text" style="width:100%; padding:10px; border-radius:8px; border:1px solid #ddd" placeholder="Adaugă sarcină simplă..." data-i18n-placeholder="task_add_simple">
                    ...
                    <h4 style="margin:0 0 10px; font-size:0.9rem" data-i18n="treatment_smart">💊 Tratament Inteligent Varroa & Hrană</h4>
                    ...
                    <div style="margin-bottom:10px;">
                        ...
                        <input type="date" id="t-start-date" value="<?php echo date('Y-m-d'); ?>" lang="ro" style="width:100%; padding:10px; border-radius:8px; border:1px solid #ddd; box-sizing:border-box;">
                    </div>
                ...
                <div style="display:flex;gap:8px;margin-bottom:20px;flex-wrap:wrap;">
                    ...
                    <button onclick="exportPDF('jurnal')" class="btn-resolve" style="flex:1;background:#e74c3c;min-width:100px;">📄 PDF Jurnal</button>
                    <button onclick="exportPDF('financiar')" class="btn-resolve" style="flex:1;background:#8e44ad;min-width:100px;">📄 PDF Financiar</button>
                ...
                <div class="card-box" style="background:#f9f9f9; border-color:#d1b490;">
                    ...
                    <div class="input-grid" style="margin-bottom:10px;">
                        <div>
                            ...
                            <input type="date" id="exp-start" lang="ro" style="width:100%; padding:10px; border-radius:8px; border:1px solid #ddd;">
                        </div>
                        <div>
                            <label style="font-size:0.8rem; font-weight:bold;">Până la:</label>
                            <input type="date" id="exp-end" lang="ro" style="width:100%; padding:10px; border-radius:8px; border:1px solid #ddd;">
                        </div>
                    </div>
